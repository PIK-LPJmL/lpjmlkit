test_that("Write LPJmL file header", {
  ...
  # Change to version 3
  suppressWarnings(h3 <- set_header_item(h4, version = 3, verbose = FALSE))
  suppressWarnings(
  ...
  # Change to version 2
  suppressWarnings(h2 <- set_header_item(h4, version = 2, verbose = FALSE))
  suppressWarnings(
  ...
  # Change to version 1
  suppressWarnings(h1 <- set_header_item(h4, version = 1, verbose = FALSE))
  suppressWarnings(
