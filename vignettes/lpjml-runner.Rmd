...
# write config files
config_details <- write_config(x = params,   model_path = model_path, sim_path = sim_path)
...
# write config files
config_details <- write_config(x = params, model_path = model_path, sim_path = sim_path, debug = TRUE)
...
params <- tibble(
  ...
  firstyear = c(1973, 1973, 1973),
  outputyear = c(-1527, -1527, -1527),
...
# check config & LPJmL
check_config(config_details[1, ], model_path, sim_path)

# submit runs to slurm
run_details <- submit_lpjml(x = config_details, model_path = model_path, sim_path = sim_path)
```
