...
date: "`r Sys.Date()`"
output: rmarkdown::md_document # pdf_document html_vignette
vignette: >
...
for the Config file(s) via `submit_lpjml` or run it (interactively) locally via
...
6. Around the Config file there are two helpful utility functions:
