...
R package **lpjmlkit**, version **1.1.2**
...
Breier J, Ostberg S, Wirth S, Minoli S, Stenzel F, Müller C (2023). _lpjmlkit: Toolkit for Basic LPJmL Handling_. doi: 10.5281/zenodo.7773134 (URL: https://doi.org/10.5281/zenodo.7773134), R package version 1.1.2, <URL: https://github.com/PIK-LPJmL/lpjmlkit>.
