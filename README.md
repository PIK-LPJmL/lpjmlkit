...
R package **lpjmlkit**, version **0.6.0**
...
Breier J, Ostberg S, Wirth S, Minoli S, Stenzel F, Müller C (2023). _lpjmlkit: Toolkit for basic LPJmL handling_. R package version 0.6.0, <URL: https://github.com/PIK-LPJmL/lpjmlkit>.
