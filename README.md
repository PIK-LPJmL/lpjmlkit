...
R package **lpjmlkit**, version **0.5.20**
...
Breier J, Ostberg S, Wirth S, Minoli S, Stenzel F, Mueller C (2023). _lpjmlkit: Toolkit for basic LPJmL handling_. R package version 0.5.20, <URL: https://github.com/PIK-LPJmL/lpjmlkit>.
