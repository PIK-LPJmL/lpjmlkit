...
R package **lpjmlkit**, version **1.0.4**
...
Breier J, Ostberg S, Wirth S, Minoli S, Stenzel F, Müller C (2023). _lpjmlkit: Toolkit for Basic LPJmL Handling_. doi: 10.5281/zenodo.7752812 (URL: https://doi.org/10.5281/zenodo.7752812), R package version 1.0.4, <URL: https://github.com/PIK-LPJmL/lpjmlkit>.
