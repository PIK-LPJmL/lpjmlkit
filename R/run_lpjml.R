...
#'   (see details). Defaults to "mpirun" (default for HPC2024 at PIK).
#'
...
#' directory of LPJmL. Using PIK infrastrucure the command is \code{mpirun}
#' for the hpc2024. To facilitate usage on the interactive (login) nodes,
