#' @title Determine the size of a LPJmL input/output file header
#'
#' @description Returns the size in bytes of a LPJmL file header based on a
...
#' }
#' @seealso
#' * [read_header()] for reading a header from a LPJmL file.
